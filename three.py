...
class Screen_One(Screen):
    def __init__(self, **kwargs):
        ...
        button3 = Button(text="Go to label", on_release=self.switch_to_screen_four)
    ...
    def switch_to_screen_four(self, *args):
        app = App.get_running_app()
        app.root.current = 'screen_four'
...
class MyApp(App):
    def build(self):
        ...
        sm.add_widget(Screen_Four(name='screen_four'))
        return sm
